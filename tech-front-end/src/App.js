      ...
      <div>
        ...
        <Switch>
            ...
            render={renderProps => (
              <Form
                ...
                model={[
                  ...
                  {
                    key: "assignment_est_hours",
                    label: "Estimated Hours",
                    type: "text",
                    props: { required: true }
                  },
                  {
                    key: "assignment_final_hours",
                    label: "Elapsed Hours",
                    type: "text",
                    props: { required: true }
                  }
                ...
                onSubmit={model => {
                  this.onAssignmentSubmit(model);
                }}
                onDelete={model => {
                  this.onDeleteAssignment(model);
                }}
              />
            )}
          />
          <Route
            ...
            render={renderProps => <AssignmentDetails {...renderProps} />}
          />
          <Route
          ...
          <Route
            ...
            render={renderProps => (
              <Form
                ...
                onSubmit={model => {
                  this.onProjectSubmit(model);
                }}
                onDelete={model => {
                  this.onDeleteProject(model);
                }}
              />
            )}
          />
          ...
          <Route
            ...
            render={renderProps => (
              <Form
                ...
                onSubmit={model => {
                  this.onEmployeeSubmit(model);
                }}
                onDelete={model => {
                  this.onDeleteEmployee(model);
                }}
              />
            )}
          />
          ...
          <Route
            ...
            render={(
              renderProps //Design form 'to-fill' data here
            ) => (
              <Form
                className="form"
                {...renderProps}
